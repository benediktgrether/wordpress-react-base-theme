...
(() => {
/*!********************************************************!*\
  !*** ./blocks/components/accordion/accordion-item.jsx ***!
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('basetheme/accordion-item', {
  title: 'Accordion Item',
  icon: _configuration_icon_icons__WEBPACK_IMPORTED_MODULE_5__.icon.accordionItem,
  category: 'layout',
...
function EditComponent(props) {
  ...
  const parentUuid = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    const {
      getBlockParentsByBlockName,
      getBlock
    } = select('core/block-editor');
    const parentBlockId = getBlockParentsByBlockName(clientId, 'basetheme/accordion-container')[0];
    return parentBlockId ? getBlock(parentBlockId).attributes.uuid : null;
  }, [clientId]);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    if (!attributes.itemUuid) {
      setAttributes({
        itemUuid: (0,uuid__WEBPACK_IMPORTED_MODULE_4__["default"])()
      });
    }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h2", {
      className: "bg-primary-default text-white px-4 py-3 font-semibold",
      ...
      className: "accordion-body bg-gray-50 p-4 text-gray-700",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
        allowedFormats: [],
...
/******/ })()
;
//# sourceMappingURL=accordion-item.jsx.js.map