...
function accordion() {
  ...
  accordions.forEach(button => {
    button.addEventListener('click', () => {
      ...
      parentAccordion.querySelectorAll('.accordion-body').forEach(body => {
        body.classList.remove('max-h-96');
        body.classList.add('max-h-0');
      });
      parentAccordion.querySelectorAll('[data-accordion-icon]').forEach(i => {
...
/***/ "./src/js/components/queryFilter.js":
/*!******************************************!*\
  !*** ./src/js/components/queryFilter.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function queryPostFilter(posts) {
  ...
  buttons.forEach(button => {
    button.addEventListener('click', function () {
      ...
      posts.forEach(post => {
        if (category === '' || post.getAttribute('data-category').includes(category)) {
...
function setSwiper(swiperID, config) {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.swiper-id-${swiperID}`), config);
}
...
function setPagination(swiperItem) {
  ...
  if (pagination) {
    return paginationConfig = {
      pagination: {
        el: `.swiper-pagination-id-${swiperItem.getAttribute('data-swiper-id')}`,
        clickable: true
      }
    };
  }
...
function setNavigation(swiperItem) {
  ...
  if (navigation) {
    return navigationConfig = {
      navigation: {
        nextEl: `.swiper-button__next-id-${swiperItem.getAttribute('data-swiper-id')}`,
        prevEl: `.swiper-button__prev-id-${swiperItem.getAttribute('data-swiper-id')}`
      }
    };
  }
  return false;
...
function setSlidesPerView(swiperItem) {
  ...
  const slidesPerView = swiperItem.getAttribute('data-swiper-slides-per-view');
...
/* harmony import */ var _components_queryFilter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/queryFilter */ "./src/js/components/queryFilter.js");
...
window.addEventListener('load', async function () {
  ...
  (0,_components_swiper__WEBPACK_IMPORTED_MODULE_1__.initSwiper)();
  (0,_components_accordion__WEBPACK_IMPORTED_MODULE_3__.accordion)();
  (0,_components_queryFilter__WEBPACK_IMPORTED_MODULE_2__.queryFilter)();
});
})();
